...
echo "Destroying zroot pool"
echo "zpool destroy zroot"
execute_command "zpool destroy zroot"
echo "Cleanup pool by zpool export -a"
echo "zpool export -a"
execute_command "zpool export -a"
